...
confpapers_data = [
    ...
    ( ['et', 'ms', 'oz', 'la', 'pr2', 'rl', 'peg', 'gdm'],              'nanoarch', 2016, 'Inversion optimization in majority-inverter graphs', '15--20', 'http://dx.doi.org/10.1145/2950067.2950072' ),
    ( ['ac2', 'ms', 'dg', 'rd'],                                        'iccad',    2016, 'Approximation-aware rewriting of AIGs for error tolerant applications', '83', 'http://doi.acm.org/10.1145/2966986.2967003' ),
    ( ['ap', 'am', 'ms', 'gdm', 'rkb', 'pi'],                           'iccad',    2016, 'Fast generation of lexicographic satisfiable assignments: enabling canonicity in SAT-based applications', '4', 'http://doi.acm.org/10.1145/2966986.2967040' ),
...
workpapers_data = [
    ...
    ( ['bs', 'ms', 'gdm', 'rkb'],                    'iwls',       2017, 'Cut generation for reverse engineering of gate-level netlists', 'XXXX', '' ),
    ( ['gm', 'ms', 'peg', 'gdm'],                    'iwls',       2017, 'A compiler for parallel and resource-constrained programmable in-memory computing', 'XXXX', '' ),
    ( ['am', 'rkb', 'ap', 'ms'],                     'iwls',       2017, 'SAT-based optimization with don\'t-cares revisited', 'XXXX', '' ),
    ( ['et', 'ms', 'oz', 'fc', 'gdm'],               'iwls',       2017, 'Exact synthesis for logic synthesis applications with complex constraints', 'XXXX', '' ),
    ( ['zc', 'ms', 'yx', 'gdm'],                     'iwls',       2017, 'Functional decomposition using majority', 'XXXX', '' ),
    ...
    ( ['zc', 'ms', 'yx', 'lw'],                      'iwls',       2018, 'Structural rewriting in XOR-majority graphs', 'XXXX', '' ),
    ( ['gm', 'ms', 'mr', 'dmm', 'ma', 'nw', 'gdm'],  'iwls',       2018, 'Estimating single-target gate T-count using spectral classification', 'XXXX', '' ),
    ( ['ms', 'hr', 'wh', 'gdm'],                     'iwls',       2018, 'The EPFL logic synthesis libraries', 'XXXX', '' ),
    ( ['ms', 'hr', 'wh', 'et', 'gdm'],               'woset',      2018, 'The EPFL logic synthesis libraries', 'XXXX', '' )
]
