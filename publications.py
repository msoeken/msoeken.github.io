...
confpapers_data = [
    ...
    ( ['hr', 'et', 'la', 'ms', 'gdm'],                                  'nanoarch', 2018, 'Size optimization of MIGs with an application to QCA and STMG technologies', 'XXXX', '', ['mockturtle'] ),
    ...
    ( ['zc', 'ms', 'yx', 'lw'],                                         'aspdac',   2019, 'Structural rewriting in XOR-majority graphs', 'XXXX', '', ['mockturtle'] ),
    ( ['hr', 'wh', 'am', 'gdm', 'ms'],                                  'date',     2019, 'On-the-fly and DAG-aware: Rewriting Boolean networks with exact synthesis', 'XXXX', '', ['mockturtle'] ),
    ( ['et', 'la', 'ms', 'am', 'pv', 'jl', 'cc', 'peg', 'gdm'],         'date',     2019, 'Scalable Boolean methods in a modern synthesis flow', 'XXXX', '', [] ),
    ( ['gm', 'ms', 'mr', 'nb', 'gdm'],                                  'date',     2019, 'Reversible pebbling game for quantum memory management', 'XXXX', '', ['caterpillar'] ),
    ( ['ms', 'fm', 'bs3', 'gdm'],                                       'date',     2019, 'Compiling permutations for superconducting QPUs', 'XXXX', '', ['tweedledum'] ),
    ( ['zc', 'wh', 'ms', 'lw', 'yx', 'gdm'],                            'iscas',    2019, 'Exact synthesis of Boolean functions in majority-of-five forms', 'XXXX', '', ['mockturtle'] ),
    ( ['db', 'ms', 'sd', 'ac', 'gdm'],                                  'ismvl',    2019, 'Reversible pebble games for reducing qubits in hierarchical quantum circuit synthesis', 'XXXX', '', ['revkit'] ),
    ( ['bs3', 'ms', 'am', 'gdm'],                                       'ismvl',    2019, 'Scaling-up ESOP synthesis for quantum compilation', 'XXXX', '', ['abc'] ),
